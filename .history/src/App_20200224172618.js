      ...
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="far fa-check-circle fa-lg" event={() => this.editor.current.applyCropping()} style={croppingImage ? {} : { display: 'none' }} />
            <Tool iconClassName="fas fa-crop-alt fa-lg" event={() => this.editor.current.set('crop')} croppingImage={style={croppingImage ? { display: 'none' } : {}}/>
          </div>
