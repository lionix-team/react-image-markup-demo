...
class App extends React.Component {
  ...
  toggleCropper = () => {
    if (this.state.croppingImage) {
      this.setState({ croppingImage: false })
    }
    else {
      this.setState({ croppingImage: true })
    }
  }
  render() {
      ...
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="far fa-check-circle fa-lg" event={() => this.editor.current.applyCropping()} croppingImage={croppingImage} toggleCropper ={this.toggleCropper}/>
            <Tool iconClassName="fas fa-crop-alt fa-lg" event={() => this.editor.current.set('crop')} croppingImage={croppingImage} toggleCropper ={this.toggleCropper}/>
          </div>
