...
class App extends React.Component {
  ...
  toggleCropper = () => {
    ...
    if (this.state.croppingImage) {
      ...
      return this.editor.current.applyCropping()

    }
    else {
      this.setState({ croppingImage: true })
      return this.editor.current.set('crop')
    }
  }
  render() {
    return (
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="far fa-check-circle fa-lg" event={() =>  this.editor.current.applyCropping()} toggleCropper ={this.toggleCropper}/>
            <Tool iconClassName="fas fa-crop-alt fa-lg" toggleCropper ={this.toggleCropper}/>
          </div>
