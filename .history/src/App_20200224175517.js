      ...
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="far fa-check-circle fa-lg" event={() => this.editor.current.applyCropping()} toggleCropper={this.toggleCropper} crop={true} style={this.state.croppingImage ? { backgroundColor: props.color } : {}}/>
            <Tool iconClassName="fas fa-crop-alt fa-lg" event={() => this.editor.current.set('crop')} toggleCropper={this.toggleCropper} crop={false} />
          </div>
