      ...
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="far fa-check-circle fa-lg" event={() => this.editor.current.applyCropping()} toggleCropper={this.toggleCropper} crop={true} style={this.state.croppingImage ? {}  : {displ}}/>
