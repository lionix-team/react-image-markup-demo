      ...
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="fas fa-crop-alt fa-lg" event={() => this.editor.current.set('crop')} toggleCropper={this.toggleCropper} crop={false} style={this.state.croppingImage ? {}  :}/>
          </div>
