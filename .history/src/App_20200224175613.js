...
class App extends React.Component {
  ...
  toggleCropper = (prop) => {
    console.log("mtac", prop)
    this.setState({ croppingImage: prop })
  }
  render() {
    return (
      <div className="app">
        ...
        <div className="container">
          <div className="tools">
            ...
            <Tool iconClassName="far fa-check-circle fa-lg" event={() => this.editor.current.applyCropping()} toggleCropper={this.toggleCropper} crop={true} style={this.state.croppingImage ? {}  : {display: "none"}}/>
            <Tool iconClassName="fas fa-crop-alt fa-lg" event={() => this.editor.current.set('crop')} toggleCropper={this.toggleCropper} crop={false} style={this.state.croppingImage ?  {display: "none"}  :}/>
          </div>
