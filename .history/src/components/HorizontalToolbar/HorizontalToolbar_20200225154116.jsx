    ...
    render(){
        return (
            <div className="tools">
                ...
                <Tool iconClassName="fas fa-font fa-lg" event={() => this.props.current.set('text')} />
                <Tool iconClassName="fas fa-pencil-alt fa-lg" event={() => this.props.current.set('freeDrawing')} />
